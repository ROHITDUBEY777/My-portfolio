...
const Contactform = () => {
  ...
  return (
   ...
   <form  id='Contact'  onSubmit={sendemail}   className='space-y-2 min-w-1/2 max-h-fit   md:h-fit w-full '>
    ...
    <textarea
     ...
     />
    <button type='submit' onSubmit={(e)=>e.preventDefault()} className='btn-2 hover:text-black  hover:border-white duration-200 border px-4 py-2'> Send </button>

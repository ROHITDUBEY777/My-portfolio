...
export default function Resume() {
  return (
    <div className='flex flex-col justify-center   mx-8 py-52 '>
      <p className='md:text-4xl text-3xl flex flex-col text-[var(--foreground)] font-bold  font-[Poppins]'>My Resume</p>

...
export default function Resume() {
  return (
    <div className='flex flex-col justify-center   mx-8 min-h-screen '>
      <p className='md:text-6xl text-3xl flex flex-col  font-[Poppins]'>My Resume</p>
      ...
      <button className='btn-2 block border-3  duration-300 border-white  transition  hover:text-black cursor-pointer text-3xl font-[Poppins] mt-4 max-w-fit px-4 py-2 min-w-1/5  h-16'>Resume</button>

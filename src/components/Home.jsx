...
const Home = () => {
  ...
  />
      ...
      <div className="absolute flex flex-col z-40 text-center px-4">
        <h1 className="space text-4xl  md:text-6xl lg:text-7xl xl:text-9xl font-semibold   pb-5">Website  Developer</h1>
        <p className="text-white opacity-60 text-lg md:text-2xl ">
